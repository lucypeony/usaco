...
Since there are only 15 feeds, and for each feed we can either give zero or one scopes of it, there are 215 possible `feed mixtures' the cows can be fed, which is only 32,768. 
Therefore, try all combinations and pick which of the legal combinations uses the least number of feeds.
*/
#include <stdio.h>
#include <assert.h>
